...
namespace twitter_clone.Migrations
{
    ...
    [Migration("20230330103002_fullnameOptional")]
    partial class fullnameOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("twitter_clone.Models.PostDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("twitter_clone.Models.Follow", b =>
                {
                    b.HasOne("twitter_clone.Models.UserDTO", "Followed")
                        .WithMany()
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("twitter_clone.Models.UserDTO", "Follower")
                        .WithMany()
            ...
            modelBuilder.Entity("twitter_clone.Models.Like", b =>
                {
                    b.HasOne("twitter_clone.Models.PostDTO", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("twitter_clone.Models.UserDTO", "User")
                        .WithMany()
